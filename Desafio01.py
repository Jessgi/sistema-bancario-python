...
def main(): 
    ...
    while True:
        ...
        # CORREÇÃO 2: A opção para criar usuário é "nu"
        elif opcao == "nu":
            criar_usuario(usuarios) # Apenas chama a função de criar usuário

        # CORREÇÃO 2: A opção para criar conta é "nc"
        elif opcao == "nc":
            numero_conta = len(contas) + 1
            conta = criar_conta(AGENCIA, numero_conta, usuarios)
            
            # CORREÇÃO 1: 'if conta:' agora está DENTRO do 'elif' correto
            if conta: 
                contas.append(conta)
